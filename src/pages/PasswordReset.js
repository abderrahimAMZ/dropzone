...
const PasswordReset = () => {
    ...
    return (
        <Layout>
            ...
            <section class="bg-gray-50 dark:bg-gray-900 sm:w-500px sm:m-auto">
                <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                    <div
                        ...
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form class="space-y-4 md:space-y-6 sm:w-500px sm:m-auto" onSubmit={handleSendVerificationCode}>
                                <div>
                                    <label for="email"
                                ...
                                <button type="submit"
                                        class="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send verification code
                                </button>
